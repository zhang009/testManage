 ...
 <link href="css/bootstrap.min.css" rel="stylesheet">
  <script type="text/javascript">
		...
		function submitAll(){
    		...
    		var point=$("#point").val();
		   var data={qa_subject:subject,qa_point:point,qa_stem:stem,qa_answer:answer,qa_analysis:analysis,qa_tb_id:tb_id,qa_ct_id:ct_id};
		   	$.ajax({
		       	   method:"post",
				...
				<form class="form-horizontal" id="totalForm">
				  ...
				  <div class="form-group">
				    <label for="stem" class="col-md-2 control-label">请填写题目</label>
				     ...
				     <div class="col-md-8">
				       <textarea id="SCStem" class="form-control" rows="5"></textarea>
				    </div>
