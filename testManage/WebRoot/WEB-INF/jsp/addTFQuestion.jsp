 ...
 <link href="css/bootstrap.min.css" rel="stylesheet">
  <script type="text/javascript">
		...
		function submitAll(){
    		...
    		var answer=$('#answer input:radio:checked').val();
    		...
    		var point=$("#point").val();
		   /* var data={tf_subject:subject,tf_point:point,tf_stem:stem,tf_answer:answer,tf_analysis:analysis,tf_tb_id:tb_id,tf_ct_id:ct_id}; */
		   var data={tf_subject:subject,tf_point:point,tf_stem:stem,tf_answer:answer,tf_analysis:analysis,tf_tb_id:tb_id,tf_ct_id:ct_id};
		   	$.ajax({
		       	   method:"post",
