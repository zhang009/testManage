		...
		<div class="panel panel-default">
			<div class="panel-body">
				<form class="form-inline" method="get" 
				      action="${pageContext.request.contextPath }/getQuestionBySubject.action">
				     <%-- 	 <c:choose>
				    <c:when test="${!empty sessionScope.SUBJECTS_SESSION }"> --%>
				     		
							<div class="form-group">
								<label for="customerFrom">请选择科目</label> 
								<select	class="form-control" id="choseSubject" name="subject">
							...
							<button type="button" class="btn btn-primary" onclick="search(this.id)">查询</button>
